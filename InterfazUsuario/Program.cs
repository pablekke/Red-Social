    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (ejecutandose)
            {
                ...
                Console.WriteLine("5. Obtener los miembros que hayan realizado más publicaciones de cualquier tipo. Si hay más de un miembro con la misma cantidad de publicaciones mostrarlos todos. Se mostrarán todos los datos de los miembros.");
